...
const Footer = () => {
    return (
        <motion.div
            ...
            className='mt-60 text-sm text-gray-500 px-6 md:px-16 lg:px-24 xl:px-32'>
            ...
            <motion.div
                ...
                >
                    ...
                    <div>
                        ...
                        <ul className='mt-3 flex flex-col gap-2 text-sm'>
                            <li><a href="#">234 Luxury Drive</a></li>
                            <li><a href="#">Andheri (E), Maharashtra, India 400069 </a></li>
                            <li><a href="#">+91 9876543210</a></li>
                            <li><a href="#">carrento@india.com</a></li>
                        </ul>
            ...
            <motion.div
                ...
                <p>© {new Date().getFullYear()} <a href="#">CarRento</a>. All rights reserved.</p>
