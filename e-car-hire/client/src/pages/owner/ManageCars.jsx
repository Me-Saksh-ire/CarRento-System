            ...
            {cars.map((car, index) => (
              <tr key={index} className='border-t border-borderColor'>
                ...
                <td className='p-3 flex items-center gap-3'>
                  <img src={car.images?.[0]} className='h-12 w-12 aspect-square rounded-md object-cover' />
                ...
                <td className='p-3 max-md:hidden'>{currency}{car.pricePerDay.toLocaleString('en-IN')}/day</td>
